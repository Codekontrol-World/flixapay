      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://blog.flixapaygroup.com" target="_blank" className="text-white/70 hover:text-fintech-teal transition-colors">Blog</a></li>
              <li><a href="" className="text-white/70 hover:text-fintech-teal transition-colors">Guides</a></li>
              <li><a href="https://help.flixapaygroup.com" target="_blank" className="text-white/70 hover:text-fintech-teal transition-colors">Help Center</a></li>
