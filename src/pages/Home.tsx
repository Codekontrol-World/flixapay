    ...
    <div className=" font-futura">
        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl lg:text-2xl mb-8 font-futura text-left">
              Seamless payments, smarter lending,
            ...
            <div className="flex justify-center md:justify-start gap-4 items-center">
              <a
                href="https://play.google.com/store/apps/details?id=com.flixa.flixa"
                target="_blank"
              ...
              >
                <img
                  src="/play-store.png"
                  alt="Google Play"
                  className="w-36 h-14 hover:scale-105 cursor-pointer"
                />
              </a>
              <a
                href="https://apps.apple.com/app/id1641853344"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
                  src="/apple-store.png"
                  alt="App Store"
                  className="w-36 h-12 hover:scale-105 cursor-pointer"
                />
              </a>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto h-full py-30 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <div className="flex flex-initial justify-center md:justify-start gap-4 items-center text-center md:text-left">
              <button
                ...
                className="border ml-2 border-[#1d8b92] hover:bg-[#1d8b92] text-black font-futura font-bold py-2 px-6 rounded transition duration-300 ease-in-out"
              >
                Waitlist
              </button>
            </div>
          ...
          >
            <p className="text-lg md:text-sm lg:text-xl mb-8 font-futura text-left">
              Flixapay stands as a visionary - with plans to revolutionize
              financial access and inclusion for individuals and businesses. An
              intuitive platform powered by our strategic partners delivers a
              comprehensive suite of services, including multi-currency wallets,
              real-time cross-border payments, micro lending, and tailored
              financial tools for SMEs. We also source integrated and innovative
              solutions such as financial wellness programs, which support
              employees with tools like earned wage access and budgeting
              resources. Additionally, revolving credit (BNPL) options are
              designed to empower consumers and businesses with flexible payment
              plans.
            </p>
          </motion.div>
        </div>
      ...
      <section className="pt-32 flex flex-col lg:flex-row font-futura items-center justify-between px-4 lg:px-16 gap-10">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-lg text-gray-700">
            Flixapay Business Banking caters to businesses of all sizes with
            scalable solutions to meet your financial needs. From streamlined
            payments and cash flow management to tailored credit and investment
            options, our platform helps you stay ahead in a fast-paced economy.
            With advanced analytics, multi-currency capabilities, and
            enterprise-grade security, Flixapay ensures your business operates
            smoothly and securely, anywhere in the world.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 py-10 font-futura">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-gradient-to-r from-indigo-700 to-purple-700 text-white p-6 rounded-lg shadow">
            <p className="text-base sm:text-lg md:text-xl font-semibold">
              Digital Revolving Credit BNPL
            </p>
          </div>
          <div className="bg-gradient-to-r from-indigo-700 to-purple-700 text-white p-6 rounded-lg shadow">
            <p className="text-base sm:text-lg md:text-xl font-semibold">
              Focus on underserved and under banked communities
            </p>
          </div>
        </div>
      </section>
