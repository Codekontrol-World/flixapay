...
const servicesData: Service[] = [
  {
    ...
    description:
      "Our Cross-Border Payments solution provides individuals and businesses with an efficient and cost-effective way to send and receive funds globally.",
    features: [
  ...
  },
  {
    ...
    description:
      "The Digital Wallets solution allows seamless transactions, global money transfers, and real-time currency exchange, all in one secure platform.",
    features: [
  ...
  },
  {
    title: "Micro-loans",
    description:
      "Our Micro-Loans service offers small loans to individuals and small businesses who might not qualify for traditional credit.",
    features: [
  ...
  },
  {
    title: "Mobile Money",
    description:
      "Mobile Money allows users to transfer money, pay bills, and make purchases directly from their mobile phones.",
    features: [
  ...
  },
  {
    ...
    description:
      "Our B2B POS Terminals support a variety of payment methods including credit cards, contactless payments, and digital wallets.",
    features: [
  ...
  },
  {
    ...
    description:
      "Our B2C Remittance service enables individuals in underserved communities to send and receive money across borders.",
    features: [
  ...
  return (
    <div className="bg-pink-50 font-futura">
      ...
      <div className="container mx-auto px-4 pt-24 md:pt-40 lg:pt-48">
        ...
        >
          We source innovative financial products designed to meet the diverse
          needs of our global customers. We strive to ensure financial
          transactions are smooth, affordable, and available to all.
        </motion.p>
      ...
      <footer className="text-center py-6 bg-pink-100">
        ...
        >
          Contact us to learn more about how our services can benefit you or
          your business. We are dedicated to making financial services
          accessible and efficient for everyone, everywhere.
        </motion.p>
      </footer>
      <Footer />
    </div>
